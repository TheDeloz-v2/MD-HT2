...
```{r }
set.seed(123)
fviz_nbclust(datos_procesados, kmeans, method = "wss") + geom_vline(xintercept = 4, linetype = 2)
...
```{r }
set.seed(123)
kmeans_result <- kmeans(datos_procesados, centers = 6)  # Asumiendo que se eligen 3 clusters
