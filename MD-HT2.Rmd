...
datos_procesados <- scale(datos_procesados)

fviz_nbclust(datos_procesados, kmeans, method = "gap_stat", k.max = 10, 
             diss = get_dist(datos_procesados, method = "euclidean"), nstart = 50)+
