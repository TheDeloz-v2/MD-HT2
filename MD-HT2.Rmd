...
datos_procesados <- subset(datos, select = -c(id, originalTitle, title, homePage, originalLanguage, video, director, genres, productionCompany, productionCompanyCountry, productionCountry, releaseDate, actors, actorsCharacter))
